...
install_as: gen_version
	CGO_ENABLED=1 GOOS=darwin GOARCH=amd64 go build -o ${GOBIN}/script ./cmd/script/ 
	CGO_ENABLED=1 GOOS=darwin GOARCH=amd64 go build -o  ${GOBIN}/scriptcli ./cmd/scriptcli/ 

exe:
	CGO_ENABLED=1 GOOS=windows GOARCH=amd64 CC=x86_64-w64-mingw32-gcc CXX=x86_64-w64-mingw32-g++ go build -o script.exe ./cmd/script/
	CGO_ENABLED=1 GOOS=windows GOARCH=amd64 CC=x86_64-w64-mingw32-gcc CXX=x86_64-w64-mingw32-g++ go build -o scriptcli.exe ./cmd/scriptcli/
