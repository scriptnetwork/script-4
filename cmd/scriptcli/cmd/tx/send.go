...
// Example:
//		scriptcli tx send --chain="testnet" --from=2E833968E5bB786Ae419c4d13189fB081Cc43bab --to=9F1233798E905E173560071255140b4A8aBd3Ec6 --script=10 --spay=9 --seq=1
//		scriptcli tx send --chain="testnet" --path "m/44'/60'/0'/0/0" --to=9F1233798E905E173560071255140b4A8aBd3Ec6 --script=10 --spay=9 --seq=1 --wallet=trezor
//		scriptcli tx send --chain="testnet" --path "m/44'/60'/0'/0" --to=9F1233798E905E173560071255140b4A8aBd3Ec6 --script=10 --spay=9 --seq=1 --wallet=nano
var sendCmd = &cobra.Command{
	Use:     "send",
	Short:   "Send tokens",
	Example: `scriptcli tx send --chain="testnet" --from=2E833968E5bB786Ae419c4d13189fB081Cc43bab --to=9F1233798E905E173560071255140b4A8aBd3Ec6 --script=10 --spay=9 --seq=1`,
	Run:     doSendCmd,
}
