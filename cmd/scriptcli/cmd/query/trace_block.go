...
// Example:
//		scriptcli query chain_of_blocks --upstream=true --hash=0xc88485a473527c55c5ddb067b018324b7e390b188e76702bc1db74dfc2dc6d13
//
var traceBlocksCmd = &cobra.Command{
	Use:     "chain_of_blocks",
	Short:   "Get chain of blocks",
	Long:    `Get chain of blocks.`,
	Example: `scriptcli query chain_of_blocks --upstream=true --hash=0xc88485a473527c55c5ddb067b018324b7e390b188e76702bc1db74dfc2dc6d13`,
	Run: func(cmd *cobra.Command, args []string) {
		client := rpcc.NewRPCClient(viper.GetString(utils.CfgRemoteRPCEndpoint))

		var res *jsonrpc.RPCResponse
		var err error
		res, err = client.Call("script.TraceBlocks", rpc.TraceBlocksArgs{
