...
func printWelcomeBanner() {
	...
	fmt.Println(" ######################################################### ")
	fmt.Println("#                                                         #")
	fmt.Println("#   _   _      _ _         _____           _       _      #")
	fmt.Println("#  | | | |    | | |       /  ___|         (_)     | |     #")
	fmt.Println("#  | |_| | ___| | | ___   \\ `--.  ___ _ __ _ _ __ | |_    #")
	fmt.Println("#  |  _  |/ _ \\ | |/ _ \\   `--. \\/ __| '__| | '_ \\| __|   #")
	fmt.Println("#  | | | |  __/ | | (_) | /\\__/ / (__| |  | | |_) | |_    #")
	fmt.Println("#  \\_| |_/\\___|_|_|\\___/  \\____/ \\___|_|  |_| .__/ \\__|   #")
	fmt.Println("#                                           | |           #")
	fmt.Println("#                                           |_|           #")
	fmt.Println("#                                                         #")
	fmt.Println(" ######################################################### ")
...
func printExitBanner() {
	...
	fmt.Println("#     | |_/ /_   _  ___  \\ `--.  ___ _ __ _ _ __ | |_     #")
	fmt.Println("#     | ___ \\ | | |/ _ \\  `--. \\/ __| '__| | '_ \\| __|    #")
	fmt.Println("#     | |_/ / |_| |  __/ /\\__/ / (__| |  | | |_) | |_     #")
	fmt.Println("#     \\____/ \\__, |\\___| \\____/ \\___|_|  |_| .__/ \\__|    #")
	fmt.Println("#             __/ |                        | |            #")
	fmt.Println("#            |___/                         |_|            #")
	fmt.Println("#                                                         #")
	fmt.Println(" ######################################################### ")
